...
if (!empty($_POST)) {
    ...
    if (empty($_POST['nombre']) || empty($_POST['correo']) || empty($_POST['usuario']) || empty($_POST['clave']) || empty($_POST['rol'])) {
        ...
        if ($result > 0) {
            ...
            // Incluir el campo estatus en la consulta INSERT
            $query_insert = mysqli_query($conection, "INSERT INTO usuario(nombre, correo, usuario, clave, rol, estatus) VALUES('$nombre', '$email', '$user', '$clave', '$rol', '$estatus')");
            if ($query_insert) {
